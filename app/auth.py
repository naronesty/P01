...
def create_db():
    ...
    c.execute("CREATE TABLE IF NOT EXISTS profiles (id INTEGER, username TEXT, template TEXT, pfp TEXT, banner TEXT, adjective TEXT, animal TEXT, joke TEXT, catFact TEXT, weatherFact TEXT);")
